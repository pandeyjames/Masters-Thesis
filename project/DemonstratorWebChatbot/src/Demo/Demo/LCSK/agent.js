...
$(function () {
    ...
    //if (isBotActive) {
    $('#login-btn-bot').click(function () {
        var agentName = "AskJames";
        var agentPass = "agent";
...
function getReplyFromBot(value) {
    if (isBotActive)
        var reply=Bot.getMsgs(value);
}
