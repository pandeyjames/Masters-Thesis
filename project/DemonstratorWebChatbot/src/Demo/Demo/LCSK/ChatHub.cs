    ...
    public class ChatHub : Hub
    {
        ...
        public void RequestChat(string message)
        {
            ...
            if (workload == null)
            {
                ...
                //Clients.Caller.addMessage("", "You can talk to our bot AskJames.");
        ...
        public void ChatWithBot(string getMsgs)
        {
            var agent = new Agent();
            if (isBotActive)
            {
               
                string SetMsg = "No Agent is available right now, You can talk to our bot AskJames.";
                Clients.Caller.addMessage("", SetMsg);
                SetMsg = string.Empty;
                isBotActive = true;
            }
            else
            {
                string SetMsg = agent.Msg;
                Clients.Caller.addMessage("", SetMsg);
            }
