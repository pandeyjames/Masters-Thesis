...
var LCSKChat = function () {
    ...
    function setDefaults() {
        ...
        options.botOnlineTitle = 'Chat with AskJames bot!';
        ...
        options.emailFailed = 'Oh! The email could not be sent at the moment.<br /><br />Sorry about that.';
    ...
    function chatRefreshState(state) {
        if (state) {
            ...
            $('#chat-box-header').text("Chat with AskJames Bot");
            //$('#chat-box-input').hide();
            if (!botActive) {
                $('#chat-box').html(
                    '<div id="chat-box-msg" style="height:265px;overflow:auto;">' +
                    '<p>Have a question? Let\'s chat!</p><p>Talk with our bot AskJames. Add your question on the field below and press ENTER.</p></div>' +
                    '<div id="chat-box-input" style="height:35px;"><textarea id="chat-box-textinput" style="width:100%;height: 32px;border:1px solid #0354cb;border-radius: 3px;" /></div>'
                );
            }
